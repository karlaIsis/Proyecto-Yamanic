...
<div action="altaAlumno.php" class="w3-card-4">
...
<div class="w3-container  w3-red">
  ...
  <p>Captura la información de cada alumno.</p>
  <form id="frmAlumno" name="frmAlumno" action="altaAlumno.php" method="post" class="w3-container" target="frameAlumno" >
